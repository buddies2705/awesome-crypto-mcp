...
- [**Awesome Memecoin Trading**](https://github.com/buddies2705/awesome-memecoin-trading) — Sister list of 295+ memecoin trading tools: launchpads (Pump.fun, LetsBonk, Bags, Believe), terminals (Axiom, Photon, GMGN, Trojan), trenches scanners, smart-money trackers, rug detectors, AI agents. Bitquery's Pump.fun + LetsBonk + Four.meme + SunPump data is the data layer for many of those tools.
- [**Awesome Crypto Tax**](https://github.com/buddies2705/awesome-crypto-tax) — Sister list of 150+ crypto tax tools (Awaken, Koinly, CoinLedger, CoinTracker, TaxBit + country-specific + DeFi/NFT/Solana specialists). Bitquery and Wallet Inspector MCPs feed raw on-chain data into AI tax-automation pipelines.
- [**Awesome Blockchain & Crypto APIs**](https://github.com/buddies2705/awesome-blockchain-crypto-api) — Sister list of 315+ blockchain APIs, RPC providers, indexers, oracles, embedded wallets, and SDKs. Every MCP in this list is built on top of an API in that one — they're the two halves of the developer-platform story.
